...
public class ForgerockTest {
  ...
  public void testBackup() {
    ...
    List<User> existingUsers = controller.load(target + "tempUsers.csv");

    ForgerockUserDao2 forgerockUserDao = createDefaultServer();
    forgerockUserDao.backupUsers(existingUsers);
  }

  @Test
  public void testReadUsers() {
    UserDao forgerockUserDao = createDefaultServer();
  ...
  private ForgerockUserDao2 createDefaultServer() {
    return new ForgerockUserDao2("http://dcs-xps:8080/", "openidm-admin", "openidm-admin");
  }
