...
public class UserManager {
    ...
    public void exportUsers(String csvFile) {
         ...
         * String[] line; while ((line = reader.readNext()) != null) { User user
         * = new User(line[0], line[1], line[2], line[3], line[4]);
         * this.addUser(user); } reader.close(); } catch (IOException exception)
         * { throw new RuntimeException(exception); }
         */
    }
