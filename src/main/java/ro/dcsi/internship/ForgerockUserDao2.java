 ...
 */
public class ForgerockUserDao2 implements UserDao {
  private static final org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(ForgerockUserDao2.class);
  ...
  public List<Pair<User, Try<String>>> writeUsersWithExceptions(List<User> users) {
  ...
  void backupUsers(List<User> theUserList) {
    ...
    new BeanBasedUserDao().writeUsers(csvFile, theUserList);
  }
