...
public class UserSyncAppGabi {
	...
	public static void main(String ... args){
		...
		options.addOption("forgerock",true,"Citeste CSV din server in un fisier"
				+ "Dati adresa serverului va rog");
		options.addOption("user",true,"Citeste CSV din server in un fisier"
				+ "Dati parola va rog");
		options.addOption("forgerockWrite",true,"Scie CSV citit anterior de pe server in un fisier"
				+ "zice-ti unde sa punem CSV");
